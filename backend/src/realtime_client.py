...
class OpenAIRealtimeClient:
    ...
    def __init__(self, session_id: str):
        ...
        self.session_config = {
            ...
            "instructions": "You are a helpful AI voice assistant. Please respond naturally and conversationally.",  # noqa: E501
            "voice": "alloy",
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            logger.debug(f"Using API key: {self.api_key[:12]}...")
            ...
            if "401" in error_message or "Unauthorized" in error_message:
                ...
                logger.error(
                    f"使用APIキー: {self.api_key[:12] if self.api_key else 'None'}..."
                )
                self.is_connected = False
                raise
    ...
    async def disconnect(self) -> None:
        ...
        if self.websocket:
            try:
                ...
                logger.warning(f"WebSocket切断中にエラー: {e}")
        self.websocket = None
        self.is_connected = False
    ...
    async def _initialize_session(self) -> None:
        ...
        session_update = {"type": "session.update", "session": self.session_config}
    ...
    async def update_session(self, config: dict[str, Any]) -> None:
        ...
        message = {"type": "session.update", "session": self.session_config}
            ...
            async for message in self.websocket:
                if isinstance(message, str):
                    try:
                        ...
                        logger.debug(
                            f"OpenAIメッセージ受信: {data.get('type', 'unknown')}"
                        )
                        yield data
    ...
    def is_alive(self) -> bool:
        ...
        Returns:
            接続状態
        """
        return self.websocket is not None and self.is_connected
